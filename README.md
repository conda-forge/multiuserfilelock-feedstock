...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/multiuserfilelock-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14628&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/multiuserfilelock-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `multiuserfilelock` can be installed with:

```
conda install multiuserfilelock
```

It is possible to list all of the versions of `multiuserfilelock` available on your platform with:
